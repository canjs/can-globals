...
/**
 * @module {{}} can-globals/js/dev/dev dev
...
module.exports = {
	...
	logLevel: 0,
	/**
	 * @function can-globals/js/dev/dev.stringify stringify
	 * @parent can-globals/js/dev/dev
	 * @description
	 *
	...
	/**
	 * @function can-globals/js/dev/dev.warn warn
	 * @parent can-globals/js/dev/dev
	 * @description
	 *
	...
	/**
	 * @function can-globals/js/dev/dev.log log
	 * @parent can-globals/js/dev/dev
	 * @description
	 *
	...
	/**
	 * @function can-globals/js/dev/dev.error error
	 * @parent can-globals/js/dev/dev
	 * @description
	 *
